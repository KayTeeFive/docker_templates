#!/bin/bash
# Usage:
#   ./start-sycl.sh          — default log verbosity (3 = info)
#   ./start-sycl.sh -v       — verbosity 4 (trace)
#   ./start-sycl.sh -d       — verbosity 5 (debug)
#   ./start-sycl.sh -vv      — --log-verbose (all messages, ∞)
#   ./start-sycl.sh -vvv     — --log-verbose (same as -vv)
