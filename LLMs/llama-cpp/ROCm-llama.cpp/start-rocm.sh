#!/bin/bash
# Usage:
#   ./start-rocm.sh          — default log verbosity (3 = info)
#   ./start-rocm.sh -v       — verbosity 4 (trace)
#   ./start-rocm.sh -d       — verbosity 5 (debug)
#   ./start-rocm.sh -vv      — --log-verbose (all messages, ∞)
#   ./start-rocm.sh -vvv     — --log-verbose (same as -vv)
